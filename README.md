...
- 🛠️ **Certifiable embedded (full-time job)**:
  I write the tools verification teams run: static and dynamic analysis of embedded software with LLVM; statement, decision and MC/DC code coverage, data/control coupling analysis; DO-178C / DO-330 tool qualification; air-gapped CI.
